...
# TESTING -----------------------------------------------------------------
  ...
  observeEvent(input$fill, {
    ...
    updateTextInput(session = session, "ind_m_2", value = "Section 2, Page 2")
    ...
    updateTextInput(session = session, "ind_m_20", value = "Line XX-ZZ")
    updateTextInput(session = session, "ind_m_21", value = "Line XX-ZZ")
    updateTextInput(session = session, "ind_m_22", value = "Line XX-ZZ")
    updateTextInput(session = session, "ind_m_23", value = "Line XX-ZZ")
    updateTextInput(session = session, "ind_m_24", value = "Line XX-ZZ")
    ...
    updateTextInput(session = session, "ind_m_28", value = "Line XX-ZZ")
    })
